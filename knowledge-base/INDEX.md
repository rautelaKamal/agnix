...
> 102 validation rules across 15 categories, sourced from 75+ references
...
|---------------|------------|
| **Implement validator** | [VALIDATION-RULES.md](./VALIDATION-RULES.md) - 102 rules with detection logic |
...
├── VALIDATION-RULES.md             # ⭐ Master validation reference (102 rules)
...
| **Total** | **75+** | **117KB** | **160KB** | **102 rules** |
...
- 102 rules with rule IDs (AS-001, CC-HK-001, etc.)
