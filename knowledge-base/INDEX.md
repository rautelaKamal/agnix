...
> 128 validation rules across 15 categories, sourced from 75+ references
...
|---------------|------------|
| **Implement validator** | [VALIDATION-RULES.md](./VALIDATION-RULES.md) - 128 rules with detection logic |
...
├── VALIDATION-RULES.md             # ⭐ Master validation reference (128 rules)
...
| **Total** | **75+** | **117KB** | **160KB** | **128 rules** |
...
- 128 rules with rule IDs (AS-001, CC-HK-001, etc.)
